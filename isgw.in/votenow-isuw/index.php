...
<div class="holder">
 <div class="video-container">
	...
	<div id="overlay"><div class="content"><h3 style="font-size:30px; color:#e27618"><center>ISGF INNOVATION AWARDS 2021<br/><span>Date: 05 March 2021 | On Digital Platform</center></span></h3></div></div>
...
<p>Voting is closed now.</p>
<!--<section class="main" style="margin-top: 10px;">
		<div class="inner">
		<div class="clearfix"></div>
		<p>&nbsp </p>
			<p style="font-size:15px;" class="cast_info"><center>Click on <strong>'VOTE NOW'</strong> and <strong>'Sign in through Twitter'</strong> to <strong>'Vote'</strong> for your favorite Nomination. An individual can caste only one vote through Twitter account. Voting will be active till 11:30AM-12:00PM 22 February 2021.<br> Your Votes will help the nominees to win this award! </center></p><br/>
...
if (!isset($_SESSION['access_token'])) {
	...
	<?php } else {
		...
		<tbody>
		<tr>
			<td>02 – 05 March 2021</td>
			<td><strong>India Smart Utility Week 2021</strong></td>
		...
		<tr>
			<td>05 March 2021</td>
			<td><strong>ISGF Innovation Awards Ceremony 2021</strong></td>
			<td>Award Distribution Ceremony</td>
			<td><a href="http://www.isgw.in/isgf-innovation-awards-2021/" target="_blank" style="color:#008000;text-decoration: underline;">View</a></td>
		</tr>
