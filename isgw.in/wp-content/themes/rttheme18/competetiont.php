<?php 
/**
 * Template Name: Payment Gateway Competiont Step 2
 */?>
...
function validatebeforesubmit(){
	if(document.getElementById("group_reg").value=='1'){
		...
		for($validatei=1;$validatei<=quantitycategory;$validatei++){
			...
			/*if(document.getElementById("designation"+$validatei).value==''){
				alert("Please fill in Details");
				return false;
			}*/
		}
			...
			<table width="100%" border="1" style="margin-top:20px;" class="pay_g">
					<thead>
						<tr style="background:#5C342B;color:#FFF;" class="step2">
							...
							<td width="25%">Price Per Team</td>
							<td width="25%">Number of Team</td>
					...
					<?php $getDetailbycategoryId = $wpdb->get_results("select * from packagecategory where category_id='".$category_id_from_url."'");
						  if($getDetailbycategoryId){
							...
							<input type="hidden" name="price" id="price" value="<?php echo $getDetailbycategoryIdResult->fee;?>">
								<?php if($getDetailbycategoryIdResult->category_id=='107'){ ?>
								<input type="hidden" name="qty" id="qty" min="0" max="6" style="width:100%;" value="3">
								1 Team (3 Persons)
								<?php } else { ?>
								<input type="hidden" name="qty" id="qty" min="0" max="6" style="width:100%;" value="4">
								1 Team (4 Persons)
								<?php  } ?>
							</td>
				...
				<div class="col-md-6" style="margin-top:10px;">
					...
					<?php if($category_id_from_url=='2' || $category_id_from_url=='27' || $category_id_from_url=='39' || $category_id_from_url=='31' || $category_id_from_url=='32' || $category_id_from_url=='72' || $category_id_from_url=='82' || $category_id_from_url=='107' || $category_id_from_url=='108'|| $category_id_from_url=='109'){?>
				...
				<input type="radio" name="radio1" id="radio_yes" value="yes"  checked="checked" style="display:none;">
				<input type="radio" name="radio1" id="radio_no" value="no" style="display:none;">
