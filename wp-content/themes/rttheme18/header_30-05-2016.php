...
<div id="container">   
	...
	<marquee width="600"><h2 style="float:left;margin-top:5px;width: 65%;text-align: center;color:#000;font-weight:bold !important;">1500+ Participants | 50+ Utilities | 203 Speakers | 33 Countries | 200+ International Delegates | 60+ Sponsors & Exhibitors | 400+ Organizations Participated | 30 Supporting Partners | 50+ Media Participation | 48 Technical Papers Published</h2></marquee>
...
<?php if ( is_page( 'home-temp' )) echo do_shortcode('[layerslider id="9"]'); ?>								